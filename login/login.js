...
Webflow.push(function () {
    ...
    var loginErrorTrigger = document.getElementById('login-error-trigger');
    var emailInput = document.getElementById('email');
    var passwordInput = document.getElementById('password');
    var rememberSessionCheckbox = document.getElementById('remember-session');
    var authURL = 'https://simbox.sequrapi.com/internal_api/users/authenticate';
    var submitText = submitButton.value;
    var waitText = submitButton.dataset.wait;
    var loginErrorDisplayed = false;
    loginForm.addEventListener('submit', handleLogin);
    function handleLogin(e) {
        return __awaiter(this, void 0, void 0, function () {
            var loginDetails, email, password, authResponse;
    ...
    function authenticateUser(email, password) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        authToken = window.btoa(email + ":" + password);
                        return [4, fetch(authURL, {
                                method: 'POST',
                                mode: 'cors',
